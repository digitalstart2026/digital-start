                        ...
                        <div className="bg-white dark:bg-dark_black p-8 rounded-2xl">
                            ...
                            <div className="my-6">
                                ...
                                <p className="mt-6 text-opacity-60">
                                    ...
                                    <Link href="https://www.paddle.com/" className="text-dark_black">(https://paddle.com)</Link>. We refer to their Privacy Statement <Link href="https://www.paddle.com/" className="text-dark_black">https://paddle.com/gdpr</Link>.
                                </p>
