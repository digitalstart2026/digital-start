                ...
                <div className="container">
                    <div className="flex flex-col justify-center gap-10 md:gap-20">
                        <div className="mx-auto max-w-2xl flex items-center text-center">
                            <h2>What our satisfied customers are saying<span className="instrument-font italic font-normal dark:opacity-70"> about us</span></h2>
                        </div>
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col xl:flex xl:flex-row gap-6">
                                <div className="flex flex-col justify-between bg-dark_black xl:max-w-25 dark:bg-white dark:bg-opacity-10 rounded-2xl p-8">
                                    <div className="flex flex-col gap-6">
                                        <span className="text-white opacity-60 uppercase text-sm font-medium">Customer stories</span>
                                        <h4 className="text-white">Their creativity and attention to detail transformed our brand completely!</h4>
                                        <div >
                                            <Image src="/images/home/customerStories/creativity_img.jpg" alt="image" width={344} height={220} className="w-full h-52" unoptimized={true} />
                                        </div>
                                    </div>
                                </div>
