                        ...
                        <div className="w-full px-4">
                            <div className="relative shadow-lg mx-auto max-w-32 overflow-hidden rounded-lg bg-white dark:bg-dark_black px-8 py-14 text-center dark:bg-dark-2 sm:px-12 md:px-16">
                                ...
                                <span className="z-1 relative my-8 block text-center">
                                    <span className="-z-1 absolute left-0 top-1/2 block h-px w-full bg-dark_black dark:bg-white dark:bg-opacity-20 bg-opacity-10"></span>
                                    <span className="text-sm text-dark_black dark:text-white dark:text-opacity-40 text-opacity-50 relative z-10 inline-block dark:bg-dark_black bg-white px-3">
                                        OR
                                    </span>
                                </span>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-5 text-left">
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className={`w-full rounded-full border px-5 py-3 outline-none transition  focus:border-dark_black dark:border-white dark:border-opacity-20
                                ...
                                <div className="flex flex-col max-w-xs mx-auto gap-2">
                                    <p className="text-dark_black text-opacity-70 dark:text-opacity-50">
                                        ...
                                        <Link href="/privacy-policy" className="text-dark_black dark:text-white dark:hover:text-opacity-50">
                                            Privacy
                                        </Link>{" "}
                                        and{" "}
                                        <Link href="/privacy-policy" className="text-dark_black dark:text-white dark:hover:text-opacity-50">
                                    ...
                                    <p className="text-dark_black text-opacity-70 dark:text-opacity-50">
                                        ...
                                        <Link href="/signin" className="text-dark_black dark:text-white dark:hover:text-opacity-50">
                                            {" "}Sign In
                                        </Link>
                                    </p>
                                </div>
