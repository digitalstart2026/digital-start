                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-5 text-left">
                      <input
                        ...
                        required
                        className="w-full rounded-full border px-5 py-3 outline-none transition dark:border-white dark:border-opacity-20 dark:focus:border-white focus:border-opacity-50 dark:focus:border-opacity-50"
                      />
                      {emailError && (
