                        ...
                        <div className="w-full px-4">
                            <div className="relative shadow-lg mx-auto max-w-32 overflow-hidden rounded-lg bg-white dark:bg-dark_black px-8 py-14 text-center sm:px-12 md:px-16">
                                ...
                                <span className="z-1 relative my-8 block text-center">
                                    ...
                                    <span className="text-sm text-dark_black dark:text-white dark:text-opacity-40 text-opacity-50 relative z-10 inline-block bg-white dark:bg-dark_black px-3">
                                        OR
                                    </span>
                                </span>
                                ...
                                <Link
                                    ...
                                    className="mb-2 inline-block text-dark_black dark:text-white dark:text-opacity-50 dark:hover:text-opacity-100 text-opacity-70 hover:text-opacity-100"
                                >
                                    Forget Password?
                                </Link>
