        ...
        <ul className="ps-3 md:ps-5 list-unstyled">
          <li className="py-2">
            <div className="flex items-center gap-3">
              <p className="text-xl text-black dark:text-grey">|—</p>
                ...
                <ul className="ps-2 ps-md-3 list-unstyled">
                  <li className="py-2">
                    <ul className="ps-3 md:ps-5 list-unstyled">
                      <li className="py-2">
                        <div className="flex items-center gap-3">
                          <p className="text-xl text-black dark:text-grey">
                            |—
                          </p>
                          <span className="font-medium text-midnight_text dark:text-grey">
                            <Icon
                          ...
                          <div className="flex flex-col justify-between gap-2 mt-2">
                            {Counts.slice(0, 30).map((item, index) => {
                              return (
                                <p
                                  key={index}
                                  className="text-xl text-black dark:text-grey"
                                >
                                  |
                                </p>
                              );
                              ...
                              <div className="flex">
                                <div className="flex flex-col justify-between gap-2 mt-2">
                                  {Counts.slice(0, 20).map((item, index) => {
                                    return (
                                      <p key={index} className="text-xl text-black dark:text-grey">
                                        |
                                      </p>
                                    );
                                  })}
                                        ...
                                        <li className="py-2">
                                          <div className="flex items-center gap-8">
                                            ...
                                            <div className="flex items-center gap-3">
                                              ...
                                              <span className="font-medium text-midnight_text dark:text-grey flex items-center flex-wrap">
                                                <Icon
                                                  icon="tabler:folder"
                                                  className="text-primary text-base inline-block me-2"
                                                />
