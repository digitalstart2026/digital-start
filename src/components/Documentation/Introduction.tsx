  ...
  return (
    <>
      <div id="version" className="md:scroll-m-[180px] scroll-m-28">
            ...
            PackageVersions && PackageVersions.map((item) => {
              return (
                <div key={item.id} className="lg:w-1/5 md:w-full text-center lg:border-b-0 border-b lg:border-e lg:last:border-e-0 last:border-b-0 border-border dark:border-dark_border">
                  ...
                  <p className="text-base font-medium text-midnight_text dark:text-grey">{item.packageName}</p>
                </div>
              )
            })
          }
        ...
        <div className="mt-5">
          <p className="text-base font-medium text-midnight_text dark:text-grey">Awake Tailwind NextJs Template is built with Tailwindcss and Nextjs.</p>
          <p className="text-base font-medium text-midnight_text dark:text-grey">These theme is ready to use and you can totally customize as per your requirement.</p>
          <p className="text-base font-medium text-midnight_text dark:text-grey">For Customize, You should have knowledge of NextJs, ReactJs, Tailwind and JSX to be able to modify these template.</p>
        </div>
